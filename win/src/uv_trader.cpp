...
void uv_trader::OnRspSettlementInfoConfirm(CThostFtdcSettlementInfoConfirmField *pSettlementInfoConfirm, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
	CThostFtdcUserLogoutField* _pSettlementInfoConfirm = nullptr;
...
void uv_trader::OnRspOrderInsert(CThostFtdcInputOrderField *pInputOrder, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
	CThostFtdcInputOrderField* _pInputOrder = nullptr;
	if (pInputOrder) {
...
void uv_trader::OnRspOrderAction(CThostFtdcInputOrderActionField *pInputOrderAction, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
	CThostFtdcInputOrderActionField* _pInputOrderAction = nullptr;
...
void uv_trader::OnErrRtnOrderAction(CThostFtdcOrderActionField *pOrderAction, CThostFtdcRspInfoField *pRspInfo) {
	CThostFtdcOrderActionField* _pOrderAction = nullptr;
	if (pOrderAction) {
...
void uv_trader::OnRspQryOrder(CThostFtdcOrderField *pOrder, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
	CThostFtdcOrderField* _pOrder = nullptr;
	if (pOrder) {
...
void uv_trader::OnRspQryTrade(CThostFtdcTradeField *pTrade, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
	CThostFtdcTradeField* _pTrade = nullptr;
	if (pTrade) {
...
void uv_trader::OnRspQryInvestorPosition(CThostFtdcInvestorPositionField *pInvestorPosition, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
	CThostFtdcInvestorPositionField* _pInvestorPosition = nullptr;
...
void uv_trader::OnRspQryInvestorPositionDetail(CThostFtdcInvestorPositionDetailField *pInvestorPositionDetail, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
	CThostFtdcInvestorPositionDetailField* _pInvestorPositionDetail = nullptr;
...
void uv_trader::OnRspQryTradingAccount(CThostFtdcTradingAccountField *pTradingAccount, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
	CThostFtdcTradingAccountField *_pTradingAccount = nullptr;
	if (pTradingAccount) {
...
void uv_trader::OnRspQryInstrument(CThostFtdcInstrumentField *pInstrument, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
	CThostFtdcInstrumentField *_pInstrument = nullptr;
	if (pInstrument) {
...
void uv_trader::OnRspQrySettlementInfo(CThostFtdcSettlementInfoField *pSettlementInfo, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
	CThostFtdcSettlementInfoField* _pSettlementInfo = nullptr;
	if (pSettlementInfo) {
...
void uv_trader::_async(uv_work_t * work) {
	...
	auto uv_trader_obj = static_cast<uv_trader*>(baton->uv_trader_obj);
	...
	case T_LOGIN_RE:
	{
					   ...
					   logger_cout(log.append("ftdc_trader_api ReqUserLogin run,the result:").append(std::to_string(baton->nResult)).c_str());
					   break;
	}
	case T_LOGOUT_RE:
	{
						...
						logger_cout(log.append("ftdc_trader_api ReqUserLogout run,the result:").append(std::to_string(baton->nResult)).c_str());
	...
	case T_CONFIRM_RE:
	{
						 ...
						 logger_cout(log.append("ftdc_trader_api ReqSettlementInfoConfirm run,the result:").append(std::to_string(baton->nResult)).c_str());
	...
	case T_INSTRUMENT_RE:
	{
							...
							logger_cout(log.append("ftdc_trader_api ReqQryInstrument run,the result:").append(std::to_string(baton->nResult)).c_str());
	...
	case T_TRADINGACCOUNT_RE:
	{
								...
								logger_cout(log.append("ftdc_trader_api ReqQryTradingAccount run,the result:").append(std::to_string(baton->nResult)).c_str());
	...
	case T_INVESTORPOSITION_RE:
	{
								  ...
								  logger_cout(log.append("ftdc_trader_api ReqQryInvestorPosition run,the result:").append(std::to_string(baton->nResult)).c_str());
	...
	case T_INVESTORPOSITIONDETAIL_RE:
	{
										...
										logger_cout(log.append("ftdc_trader_api ReqQryInvestorPositionDetail run,the result:").append(std::to_string(baton->nResult)).c_str());
	...
	case T_INSERT_RE:
	{
						...
						logger_cout(log.append("ftdc_trader_api ReqOrderInsert run,the result:").append(std::to_string(baton->nResult)).c_str());
	...
	case T_ACTION_RE:
	{
						...
						logger_cout(log.append("ftdc_trader_api ReqOrderAction run,the result:").append(std::to_string(baton->nResult)).c_str());
	...
	case T_MARGINRATE_RE:
	{
							...
							logger_cout(log.append("ftdc_trader_api ReqQryInstrumentMarginRate run,the result:").append(std::to_string(baton->nResult)).c_str());
	...
	case T_DEPTHMARKETDATA_RE:
	{
								 ...
								 logger_cout(log.append("ftdc_trader_api ReqQryDepthMarketData run,the result:").append(std::to_string(baton->nResult)).c_str());
	...
	case T_SETTLEMENTINFO_RE:
	{
								...
								logger_cout(log.append("ftdc_trader_api ReqQrySettlementInfo run,the result:").append(std::to_string(baton->nResult)).c_str());
